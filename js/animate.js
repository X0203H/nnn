...
function setCss(obj, attr, val) {
  ...
  if (arguments.length == 2) {
    ...
    if (
      ...
      var val = obj.currentStyle
        ? parseInt(obj.currentStyle[attr])
        : parseInt(getComputedStyle(obj, null)[attr]);
      if (!val) {
        var str =
          "offset" + attr.replace(attr.charAt(0), attr.charAt(0).toUpperCase());
        val = obj[str];
      }
      return val;
    }
    ...
    if (
      ...
      var cc = parseInt(
        obj.currentStyle
          ? obj.currentStyle[attr] == undefined ||
            obj.currentStyle[attr] == "auto"
            ? 0
    ...
    if (attr == "opacity") {
      return obj.currentStyle
        ? parseFloat(obj.currentStyle[attr] || 1)
        : parseFloat(getComputedStyle(obj, null)[attr] || 1);
    }
    //��ɫ
    if (
      attr == "color" ||
      ...
      var colors = obj.currentStyle
        ? obj.currentStyle[attr] || "#000000"
        : getComputedStyle(obj, null)[attr] || "#000000";
      //��ȡ����
